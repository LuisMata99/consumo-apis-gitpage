...
const PROFILE = {
  ...
  // ⬇️ CORRECCIÓN: Faltaban comillas en el string
...
const EXPERIENCIA = [
  {
    ...
    fin: "Actual",
    logros: [
      "Optimicé el plan curricular 7+1",
      "Integré IA en evaluación formativa",
    ],
  },
  {
    empresa: "UNIR",
...
export default function AcercaDeMi() {
  ...
  // 1) Early return (validación): si no hay perfil, no pintamos nada
  ...
  // 2) switch para decidir la clase visual del nivel
  ...
  // Helper visual (condicional por estado)
  const cardBase =
    ...
    >
      ...
      >
        <div className="mx-auto mb-4 h-24 w-24 overflow-hidden rounded-full ring-2 ring-white/50 shadow-lg">
          {/* Reemplaza la imagen por tu avatar */}
          <img
        ...
        <div className="mt-3 flex items-center justify-center gap-3 text-sm text-zinc-600 dark:text-zinc-300">
          ...
          {/* ⬇️ CORRECCIÓN: Faltaban backticks en href */}
          <a
      ...
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            // ⬇️ CORRECCIÓN: Faltaban backticks en className
      ...
      {/* Habilidades (demuestra control de flujo con filtros y switch) */}
      <section className="mb-10">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 lg:grid-cols-3">
          {habilidadesFiltradas.map((h) => (
            ...
            <div
              key={h.nombre}
              className={`${cardBase} flex items-center justify-between p-4`}
            >
              <div>
      ...
      {/* Línea de tiempo (map + condicionales) */}
      <section className="mb-10">
        <h3 className="mb-3 text-lg font-semibold tracking-tight text-zinc-900 dark:text-zinc-100">
          Experiencia
        </h3>
        <ol className="relative border-s border-zinc-200 dark:border-zinc-700">
          {EXPERIENCIA.map((item, idx) => {
            ...
            return (
              // ⬇️ CORRECCIÓN: Faltaban backticks en key
              <li key={`${item.empresa}-${idx}`} className="mb-8 ms-4">
                ...
                <div className={`${cardBase} p-4`}>
                  ...
                  {/* Mostrar logros en modo detallado */}
                  {!modoCompacto ? (
      ...
      >
        <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
          <div>
            ...
            <p className="text-sm text-zinc-600 dark:text-zinc-300">
              Escríbeme y construyamos soluciones claras, accesibles y
              sostenibles.
            </p>
          </div>
